    ...
    return (
        <div className='pb-5'>
            ...
            <div className='container my-5 pb-5'>
                ...
                <div className='text-center'>
                    <img src="https://res.cloudinary.com/practicaldev/image/fetch/s--paCGhFRY--/c_limit%2Cf_auto%2Cfl_progressive%2Cq_auto%2Cw_880/https://thepracticaldev.s3.amazonaws.com/i/tppls6i2nbdqevr2nybr.png" className='p-2 w-50' alt="" />
                </div>
                <br /><br />
                ...
                <div  className='border-start ps-4'>
                    ...
                    <div className='text-center'>
                    <img src="https://strongloop.com/blog-assets/2014/01/threading_node.png" className='p-2 w-50' alt="" />
                    </div> 
                    <br />
                <div  className='border-start ps-4'>
