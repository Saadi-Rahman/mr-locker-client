                    ...
                    <section className="">
                        <div className="row">
                            ...
                            <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                                <h6 className="text-uppercase text-warning mb-4 font-weight-bold">Services</h6>
                            ...
                            <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                                <h6 className="text-uppercase text-warning mb-4 font-weight-bold">Useful links</h6>
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                                <h6 className="text-uppercase text-warning mb-4 font-weight-bold">Contact</h6>
                                <p><FaHome className='me-2' /> Charlotte, NC 10012, US</p>
